...
import com.model.base.utils.HttpUtil;
...
public class WxApi {
	private static Logger logger = Logger.getLogger(WxApi.class);
	//token 接口
	...
	public static JSONObject httpsRequest(String requestUrl, String requestMethod, String outputStr) {
		...
		try {
			...
			jsonObject = JSONObject.fromObject(bufferStr);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonObject;
	...
	public static void main(String[] args) {
		String appId = "wx68246d9e760331ab";
		String appSecret = "cdd97d5a0ccec39e7e32ed87c9a1678a";
